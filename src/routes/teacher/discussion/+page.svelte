...
<div class="flex">
    ...
    <div class="neutral-wrapper px-3">
        <Navbar variant="inside" pageTitle="Forum Diskusi" bind:user={user} bind:isSidebarOpen={isSidebarOpen}/>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
                        <div class="card radius-sm">
                            <div class="card-body">
                                ...
                                <Button type="link" href="/teacher/discussion/{course.id}" classList="btn btn-main radius-sm">Lihat Diskusi</Button>
                            </div>
                        </div>
                    </div>
                    {/each}
