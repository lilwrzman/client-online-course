<script>
    ...
    import { ImageFill, ExclamationLg, NutFill, CheckLg, Hourglass, PersonWorkspace, Coin, PersonFill, PencilFill, PassFill, LightbulbFill, Trash, TrashFill, List, PlusLg, PlayCircle, FileEarmarkText, Pass, X, PencilSquare, CheckSquareFill, SquareFill, XSquareFill } from "svelte-bootstrap-icons"
        ...
        <main style="flex-grow: 1; overflow-y: hidden;" class="flex-column">
            <div class="container flex-column py-4 gap-5" style="flex-grow: 1;">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="/teacher/course/{id}" class="body-medium-semi-bold tc-primary-main">{ detail ? detail.title : '' }</a>
                </div>
                        ...
                        <div class="card radius-sm" transition:fly={{ delay: 250, duration: 300, y: 100, opacity: 0, easing: quintOut }}>
                            <div class="card-body gap-4">
                                <div class="flex-column gap-1">
                                    ...
                                    <div class="body-small-reguler">Anda adalah pemateri untuk materi ini!</div>
                                </div>
                        ...
                        <div class="card radius-sm" transition:fly={{ delay: 250, duration: 300, y: 100, opacity: 0, easing: quintOut }}>
                            <div class="card-body gap-4">
                                <div class="flex-column gap-1">
                                    ...
                                    <div class="body-small-reguler">Harga telah diatur oleh Admin LPK.</div>
                                </div>
                        ...
                        <div class="card radius-sm" transition:fly={{ delay: 250, duration: 300, y: 100, opacity: 0, easing: quintOut }}>
                            <div class="card-body gap-4">
                                <div class="flex justify-content-between align-items center">
                                    ...
                                    {#if !exam}
                                    <Button type="link" href="/teacher/course/{id}/exam" classList="btn btn-main-outline">Tambah Ujian</Button>
                                    {/if}
                                </div>
                                    ...
                                    <div class="flex-column gap-3" id="datalist">
                                            ...
                                            <div class="flex-column gap-2" animate:flip="{{ duration: flipDurationMs }}">
                                                <div class="flex gap-2 align-items-center">
                                                    ...
                                                    <div class="flex gap-3 px-2">
                                                        <Button type="link" href="/teacher/course/{id}/{item.type.toLowerCase()}/{item.id}" classList="btn btn-no-padding">
                                                            <div class="flex justify-content-center align-items-center">
                                                                <PencilSquare/>
                                                            </div>
                                                        </Button>    
                                        ...
                                        <div class="flex-column gap-2">
                                            <div class="flex gap-2 align-items-center">
                                                ...
                                                <div class="flex gap-3 px-2">
                                                    <Button type="link" href="/teacher/course/{id}/exam/{exam.id}" classList="btn btn-no-padding">
                                                        <div class="flex justify-content-center align-items-center">
                                                            <PencilSquare/>
                                                        </div>
                                                    </Button>    
                                                ...
                                                <div class="flex-column w-100 gap-2">
                                                    ...
                                                    <div class="row justify-content-center gap-2">
                                                        <div class="col-3 px-0">
                                                            <Button type="link" href="/teacher/course/{id}/video{newItem ? `?title=${newItem}` : ''}" classList="btn btn-neutral-outline-disabled w-100">Video</Button>
                                                        </div>
                                                        <div class="col-3 px-0">
                                                            <Button type="link" href="/teacher/course/{id}/quiz{newItem ? `?title=${newItem}` : ''}" classList="btn btn-neutral-outline-disabled w-100">Kuis</Button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
