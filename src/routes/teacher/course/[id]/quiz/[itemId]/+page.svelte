		...
		ApiController.sendRequest({
			...
			.catch((e) => {
				...
				if (response.error) {
					...
					toastData = {
						title: 'Gagal',
						message: 'Mohon periksa kembali data kuis!',
						color: 'toast-danger'
					}
					toastVisible = true
					return
...
<div class="flex">
	...
	<div class="neutral-wrapper px-3">
		<Navbar active="" variant="inside" pageTitle="Bank Kursus" bind:user />
				...
				{#if status}
					<div class="row justify-content-center">
						<div class="flex gap-2 col-12 col-md-10 p-0">
							<a href="/teacher/course" class="body-medium-semi-bold tc-neutral-disabled"
								>Materi</a
							>
							<div class="body-medium-semi-bold tc-neutral-disabled">/</div>
							<a
								href="/teacher/course/{id}?active=Submateri"
								class="body-medium-semi-bold tc-neutral-disabled">{detail.course.title}</a
							>
							<div class="body-medium-semi-bold tc-neutral-disabled">/</div>
							<a href="/teacher/course/{id}/quiz#" class="body-medium-semi-bold tc-primary-main"
								>Kuis</a
							>
						</div>
					</div>
