...
<div class="flex">
    ...
    <div class="neutral-wrapper px-3">
        <Navbar active="" variant="inside" pageTitle="Dashboard"/>
        <main>
            <div class="container flex-column py-4 gap-8">
                    ...
                    <div class="card-body gap-5">
                        <div class="flex justify-content-between">
                            <div class="flex-column">
                                <div class="body-small-semi-bold">Welcome to SuperAdmin Area</div>
                                <div class="caption-light">All documents here are confidential.</div>
                            </div>
                            <div class="flex-column">
                        ...
                        <div class="flex justify-content-between flex-wrap">
                            <div class="flex-column align-items-center px-2 flex-item-md-3 flex-item-sm-6 flex-item-xs-12 mb-4">
                                ...
                                <div class="flex-column align-items-center py-2">
                                    <div class="caption-reguler">999</div>
                                    <div class="caption-light">Total Student</div>
                                </div>
                            </div>
                            <div class="flex-column align-items-center px-2 flex-item-md-3 flex-item-sm-6 flex-item-xs-12 mb-4">
                                ...
                                <div class="flex-column align-items-center py-2">
                                    <div class="caption-reguler">999</div>
                                    <div class="caption-light">Total Content</div>
                                </div>
                            </div>
                            <div class="flex-column align-items-center px-2 flex-item-md-3 flex-item-sm-6 flex-item-xs-12 mb-4">
                                ...
                                <div class="flex-column align-items-center py-2">
                                    <div class="caption-reguler">999</div>
                                    <div class="caption-light">Total Corporate</div>
                                </div>
                            </div>
                            <div class="flex-column align-items-center px-2 flex-item-md-3 flex-item-sm-6 flex-item-xs-12 mb-4">
                                ...
                                <div class="flex-column align-items-center py-2">
                                    <div class="caption-reguler">999</div>
                                    <div class="caption-light">Total Transaction</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card p-4 drop-shadow">
                    <div class="card-body gap-5">
                        <div class="flex justify-content-between">
                            <div class="body-small-semi-bold">Latest Rating & Review</div>
                            <a href="/" class="link caption-reguler-thin">View All</a>
                        </div>
                        {#if ratingReviewData}
                        ...
                        <div class="flex justify-content-center align-items-center w-100 py-8">
                            <div class="flex-column align-items-center gap-3 py-8">
                                ...
                                <div class="caption-reguler tc-neutral-disabled">Ups, you don’t have any ratings or review yet</div>
                            </div>
                        </div>
                        {/if}
                    </div>
