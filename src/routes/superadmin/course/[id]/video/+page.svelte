        ...
        <main style="flex-grow: 1; overflow-y: hidden;" class="flex-column">
            <div class="container flex-column py-4 gap-5" style="flex-grow: 1;">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="/superadmin/course/{id}" class="body-medium-semi-bold tc-neutral-disabled">{detail.title}</a>
                    <div class="body-medium-semi-bold tc-neutral-disabled">/</div>
                    <a href="/superadmin/course/{id}/video#" class="body-medium-semi-bold tc-primary-main">Video</a>
                </div>
