        ...
        <main style="flex-grow: 1; overflow-y: hidden;" class="flex-column">
            <div class="container flex-column py-4 gap-4" style="flex-grow: 1;">
                <div class="flex gap-2">
                    <a href="/superadmin/progress" class="body-medium-semi-bold tc-neutral-disabled">Progress Karyawan</a>
                    <div class="body-medium-semi-bold tc-neutral-disabled">/</div>
                    <a href="/superadmin/progress/{$page.params.id}" class="body-medium-semi-bold tc-primary-main">{ course ? course.title : '' }</a>
                </div>
