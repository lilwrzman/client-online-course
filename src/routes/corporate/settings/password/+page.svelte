...
<div class="flex">
    <Sidebar active="else" role="Corporate Admin" bind:isSidebarOpen={isSidebarOpen} />
            ...
            <div class="container flex-column py-4 gap-4" style="flex-grow: 1;">
                ...
                <div class="card p-standard radius-sm">
                    <div class="card-body gap-4">
                        <Tab type="link" menus={[
                            {title: "Profil", href: "/corporate/settings/profile", active: false},
                            {title: "Kata Sandi", href: "/corporate/settings/password", active: true}
                        ]} />
