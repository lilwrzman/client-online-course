    ...
    <div class="sidebar">
        <div class="flex-column p-3" style="gap: 14px;">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <button class="menu {isOpen ? 'menu-active' : ''} justify-content-between" on:click={handleOpen}>
                        <div class="flex gap-4">
                            <BriefcaseFill width=20 height=20 color={isOpen ? '#3951A8' : '#8191AC'}/>
                            <p class="body-small-semi-bold {isOpen ? 'tc-primary-main' : 'tc-neutral-primary'}">Bank Kursus</p>
                        </div>
                        {#if isOpen}
                    ...
                    <div class="menu-dropdown">
                        <a href="/superadmin/learning-path" class="menu-dropdown-item">
                            <div class="flex gap-4">
                                ...
                                <p class="body-small-semi-bold {active == 'Alur Belajar' ? 'tc-primary-main' : 'tc-neutral-primary'}">Alur Belajar</p>
                            </div>
                        </a>
                        <a href="/superadmin/course" class="menu-dropdown-item">
                            <div class="flex gap-4">
                                <BriefcaseFill width=20 height=20 color='transparent'/>
                                <p class="body-small-semi-bold {active == 'Materi' ? 'tc-primary-main' : 'tc-neutral-primary'}">Materi</p>
                            </div>
                        </a>
                    </div>
                    {/if}
                ...
                <li>
                    <a href="/superadmin/transaction" class="menu {active == 'Transaksi' ? 'menu-active' : ''}">
                        <WalletFill width=20 height=20 color={active == "Transaksi" ? '#3951A8' : '#8191AC'}/>
                        <p class="body-small-semi-bold {active == "Transaksi" ? 'tc-primary-main' : 'tc-neutral-primary'}">Transaksi</p>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="/superadmin/event" class="menu {active == 'Manajemen Event' ? 'menu-active' : ''}">
                        <Calendar2EventFill width=20 height=20 color={active == "Manajemen Event" ? '#3951A8' : '#8191AC'}/>
                        <p class="body-small-semi-bold {active == "Manajemen Event" ? 'tc-primary-main' : 'tc-neutral-primary'}">Manajemen Event</p>
                    </a>
                </li>
                <li>
